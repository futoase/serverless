...
describe('AwsCompileFunctions', () => {
  ...
  describe('#compileFunctions()', () => {
    ...
    describe('when using onFailure config', () => {
      let s3Folder;
      let s3FileName;
      ...
      it('should create a function resource with DeadLetterConfig if arn is provided', () => {
        awsCompileFunctions.serverless.service.functions = {
          func: {
            handler: 'func.function.handler',
            name: 'new-service-dev-func',
            onFailure: 'arn:aws:sns:region:accountid:foo',
          },
        };
